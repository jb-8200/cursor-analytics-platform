...
gcloud run deploy ${SERVICE_NAME} \
  ...
  --set-env-vars CURSOR_SIM_MODE=runtime,CURSOR_SIM_SEED=/app/seed.json,CURSOR_SIM_DAYS=${DAYS},CURSOR_SIM_VELOCITY=${VELOCITY},CURSOR_SIM_PORT=8080,CURSOR_SIM_DEVELOPERS=${CURSOR_SIM_DEVELOPERS:-50},CURSOR_SIM_MAX_COMMITS=${CURSOR_SIM_MAX_COMMITS:-1000}
